...
If copy/pasting is too much, here's a sandbox of the current state.
...
If you haven't worked with it before, React provides us with this neat little set of functions inside of localStorage (you don't even have to import it!). localStorage has methods such as get, set, and delete.
